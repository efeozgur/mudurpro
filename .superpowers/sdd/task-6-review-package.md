 .../src/common/interceptors/tenant.interceptor.ts  |  36 ++++
 .../modules/tenant/entities/courthouse.entity.ts   |  18 ++
 backend/src/modules/tenant/tenant.module.ts        |   9 +
 backend/src/modules/tenant/tenant.service.ts       | 198 +++++++++++++++++++++
 4 files changed, 261 insertions(+)
diff --git a/backend/src/common/interceptors/tenant.interceptor.ts b/backend/src/common/interceptors/tenant.interceptor.ts
new file mode 100644
index 0000000..c932706
--- /dev/null
+++ b/backend/src/common/interceptors/tenant.interceptor.ts
@@ -0,0 +1,36 @@
...
+  }
+}
diff --git a/backend/src/modules/tenant/entities/courthouse.entity.ts b/backend/src/modules/tenant/entities/courthouse.entity.ts
new file mode 100644
index 0000000..a7d517a
--- /dev/null
+++ b/backend/src/modules/tenant/entities/courthouse.entity.ts
@@ -0,0 +1,18 @@
...
+  active!: boolean;
+}
diff --git a/backend/src/modules/tenant/tenant.module.ts b/backend/src/modules/tenant/tenant.module.ts
new file mode 100644
index 0000000..c337578
--- /dev/null
+++ b/backend/src/modules/tenant/tenant.module.ts
@@ -0,0 +1,9 @@
...
diff --git a/backend/src/modules/tenant/tenant.service.ts b/backend/src/modules/tenant/tenant.service.ts
new file mode 100644
index 0000000..4e23fc1
--- /dev/null
+++ b/backend/src/modules/tenant/tenant.service.ts
@@ -0,0 +1,198 @@
