...
---
 ...
 backend/.gitignore            |    3 +
 backend/jest.config.js        |    9 +
 backend/nest-cli.json         |    6 +
 backend/package-lock.json     | 9096 +++++++++++++++++++++++++++++++++++++++++
 backend/package.json          |   45 +
 backend/src/app.controller.ts |    9 +
 backend/src/app.module.ts     |   16 +
 backend/src/main.ts           |   12 +
 backend/test/jest-e2e.json    |    7 +
 backend/tsconfig.json         |   18 +
 11 files changed, 9224 insertions(+)

---

diff --git a/backend/.env.example b/backend/.env.example
new file mode 100644
index 0000000..7df28e1
--- /dev/null
